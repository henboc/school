...
<body>
    ...
    <section class="sec4">
       <div class="container">
        ...
        <div class="row">
        <div class="img2 col-sm-4" style="background-image: url('images/pic0.jpg');">
        ...
        <div class="img3 col-sm-4" style="background-image: url('images/img.jpg');">
        ...
        <div class="img4 col-sm-4" style="background-image: url('images/wap.jpg');">
